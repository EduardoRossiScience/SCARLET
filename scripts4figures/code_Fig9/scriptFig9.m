...
% 2) copy the file "SCARLET_v1_GMDplotFig9.m" inside the folder
% "source_code"
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generation of points associated with spheres in Fig. 9 (black dots in the plot) 
...
[output_st] = SCARLET_v1_GMDplotFig9(cored_struct, N_particles, ...
...
% % reported in the round brackets of Fig.9 
% cone = 10;                                                                 
% rays = 1;
% euler = 1;
% 
