...
% 2) copy the file "SCARLET_v1_GMDplotFig11_12.m" inside the folder
% "source_code"
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generation of points associated with Fig. 11 and Fig.12. 
% Please note that the present script just generates one of the 16 plots
% reported in each of the two figures (Fig.11 and Fig.12). In order to have
...
[sph_particle, fv] = fromStlToSpheres('../STL_examples/Fig11_Fig12/ParticleParticle16.stl', 50, 1, 1, 0);

% TO BE MODIFIED BY THE USER
% This is the setup that makes the difference between Fig.11 and Fig.12.
...
for i = 1:N_repetitions
    ...
    for j = 1:length(ratios)
        ...
        [output_st] = SCARLET_v1_GMDplotFig11_12(cored_struct, N_particles, ...
