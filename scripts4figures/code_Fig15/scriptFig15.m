...
% 2) copy the file "SCARLET_v1_GMDplotFig15.m" inside the folder
% "source_code"
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generation of plots reported in Fig. 15
...
for i=1:N_repetitions
    [output_st, vector_collisions] = SCARLET_v1_GMDplotFig15(agg_27_sk21, vettore_taglie, ...
